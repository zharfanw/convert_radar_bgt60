...
% alpha   - the balancing parameter of the data-fidelity constraint // Penalty factor, also known as balance parameter
% tau     - time-step of the dual ascent ( pick 0 for noise-slack ) // noise tolerance
% K       - the number of modes to be recovered // Decomposed mode number
% DC      - true if the first mode is put and kept at DC (0-freq) // DC component
% init    - 0 = all omegas start at 0 Initialize the center frequency
%                    1 = all omegas start uniformly distributed
%                    2 = all omegas initialized randomly
% tol     - tolerance of convergence criterion; typically around 1e-6 // Convergence Criterion Tolerance
%
% Output:
% -------
% u       - the collection of decomposed modes 分解模式的集合
% u_hat   - spectra of the modes 模式的频谱
% omega   - estimated mode center-frequencies 估计模式中心频率
%
...
% other inits
uDiff = tol+eps; % update step（tol is the tolerance of the convergence criterion) the termination condition, that is, theε
n = 1; % loop counter
