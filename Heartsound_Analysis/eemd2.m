...
%% ------------------------------------------------------------------------
function [imfEns,imf] = eemd2(x,fs,stdNoiseRel,nEns,maxNumImf,dispOn)
%% EEMD()
...
%                        plot('Time (s)',['IMF',num2str(nImf)],ax1(nImf),[],[],0);  
                   else
                       plotCute1('Time (s)',['IMF',num2str(nImf)],ax1(nImf),[],...
                           {'EEMD','EMD'},1);  
%                        plot('Time (s)',['IMF',num2str(nImf)],ax1(nImf),[],...
%                            {'EEMD','EMD'},1);  
                   end
               else
                   plotCute1([],['IMF',num2str(nImf)],ax1(nImf),[],[],0);   
%                    plot([],['IMF',num2str(nImf)],ax1(nImf),[],[],0);   
               end
            end
        end
    end
